...
Reuses `series-2.1/prune.py` for evidence filtering and `common/` for shared helpers.
...
python series-2.2/app.py --cache-version v3
```

## Flow

1. Load HDFS logs, prune evidence (`series-2.1/prune.py`)
